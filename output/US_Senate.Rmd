...
As can be seen in the following table, Using these four elements, I will show in a following graph how strong is the loyalty of each senator to his or her leader with a dot plot. 
...
```{r, eval=FALSE}
ggplot(mean, aes(x = office, y = loyalty, color = party, label = name)) +
  geom_point() +
  scale_color_manual(values = c("blue", "green", "red")) +
  scale_y_discrete()
```
![Loyalty plot](C:\Users\fcata\OneDrive\Desktop\Capstone_project_FC\fig\Rplot07.png)
...
2.	The second one contains the full list of the cosponsors of each introduced bill, that have almost 59 columns for each cosponsor with a lot of Naif there is less than 59 cosponsors
...
```
![Social Network Analysis](C:\Users\fcata\OneDrive\Desktop\Capstone_project_FC\fig\last-attempt.png)
